import{_ as C,l as o,e as a,a as t,D as q,z as L,i as c,F as v,p,d as k,m as u,c as b,v as m,t as x}from"./index-T0-zinqk.js";const B={class:"h5-page"},F={class:"search-bar"},M={class:"category-tabs"},D=["onClick"],V={class:"h5-content"},$={class:"faq-list"},j=["onClick"],z={class:"faq-title"},I={key:0,class:"faq-answer"},N={key:0,class:"empty-state"},E={__name:"Faq",setup(K){const f=m(),r=u(""),l=u(""),g=["服务态度","医疗质量","就医流程","环境卫生","其他"],y=u([{category:"服务态度",title:"医护人员态度不好怎么办？",content:`如遇到医护人员态度不好的情况，请记录具体时间、地点和人员，可通过以下渠道进行反馈：
