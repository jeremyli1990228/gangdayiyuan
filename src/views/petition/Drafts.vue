  ...
  <div class="page-container">
    ...
    <div class="table-container">
      <div class="table-header">
        ...
        <div class="table-cell" style="width: 100px;">工单平台来源</div>
        <div class="table-cell" style="width: 150px;">涉及科室</div>
        <div class="table-cell" style="width: 100px;">工单分类</div>
        <div class="table-cell" style="width: 100px;">紧急程度</div>
        <div class="table-cell" style="width: 120px;">保存时间</div>
      ...
      <div class="table-body">
        <div class="table-row" v-for="(item, index) in tableData" :key="index">
          ...
          <div class="table-cell" style="width: 100px;">{{ item.source }}</div>
          <div class="table-cell" style="width: 150px;">{{ item.department }}</div>
          <div class="table-cell" style="width: 100px;">{{ item.category }}</div>
          <div class="table-cell" style="width: 100px;">
            <span :class="['urgency-tag', urgencyClass(item.urgency)]">{{ item.urgency }}</span>
          </div>
          <div class="table-cell" style="width: 120px;">{{ item.saveTime }}</div>
          <div class="table-cell" style="width: 140px;">
            <button class="btn btn-primary btn-edit" @click="editDraft(item)">编辑</button>
            <button class="btn btn-outline btn-delete" @click="deleteDraft(index)">删除</button>
          </div>
        </div>
      </div>
