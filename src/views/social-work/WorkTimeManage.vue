<template>
  <div class="page-container">
    <div class="breadcrumb">
      ...
      <span class="breadcrumb-item">社工管理</span>
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-item active">工时管理</span>
    </div>
    ...
    <div class="table-section">
      <div class="table-container">
        <div class="table-header">
          ...
          <div class="table-cell" style="width: 120px;">社工姓名</div>
          <div class="table-cell" style="width: 150px;">社工电话</div>
          <div class="table-cell" style="width: 200px;">招聘标题</div>
          <div class="table-cell" style="width: 100px;">工时</div>
          <div class="table-cell" style="width: 180px;">上班打卡时间</div>
          <div class="table-cell" style="width: 180px;">下班打卡时间</div>
