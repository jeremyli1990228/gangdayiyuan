  ...
  <div class="h5-page">
    ...
    <div class="h5-content">
      ...
      <div class="form-section">
        ...
        <div class="form-item required">
          <label class="form-label">反馈人与就诊人关系</label>
          <div class="radio-group">
            <label class="radio-item" v-for="item in relationOptions" :key="item.value">
              <input type="radio" v-model="formData.relation" :value="item.value">
              <span class="radio-text">{{ item.label }}</span>
            </label>
          </div>
        </div>
        ...
        <div class="form-item required">
          ...
          <div class="address-row">
            <select class="form-select" v-model="formData.province" @change="onProvinceChange">
              <option value="">所在省</option>
              <option v-for="p in regionData" :key="p.name" :value="p.name">{{ p.name }}</option>
            </select>
            <select class="form-select" v-model="formData.city" @change="onCityChange" :disabled="!formData.province">
              <option value="">所在市</option>
              <option v-for="c in cityOptions" :key="c.name" :value="c.name">{{ c.name }}</option>
            </select>
            <select class="form-select" v-model="formData.district" :disabled="!formData.city">
              <option value="">所在街道(乡镇)</option>
              <option v-for="d in districtOptions" :key="d" :value="d">{{ d }}</option>
            </select>
          </div>
          <input type="text" class="form-input" v-model="formData.address" placeholder="请输入详细地址" style="margin-top: 8px;">
        </div>

        <div class="form-item required">
          <label class="form-label">被反馈人员科室</label>
          <input type="text" class="form-input" v-model="formData.staffDept" placeholder="请输入被反馈人员科室">
        </div>

        <div class="form-item required">
          <label class="form-label">被反馈人员姓名</label>
          <input type="text" class="form-input" v-model="formData.staffName" placeholder="请输入被反馈人员姓名">
        </div>

        <div class="form-item required">
          <label class="form-label">被反馈人员类别</label>
          <div class="radio-group">
            <label class="radio-item" v-for="item in staffCategoryOptions" :key="item.value">
              <input type="radio" v-model="formData.staffCategory" :value="item.value">
              <span class="radio-text">{{ item.label }}</span>
            </label>
          </div>
        </div>
...
const staffCategoryOptions = ref([
  { label: '医生', value: 'doctor' },
  { label: '护士', value: 'nurse' },
  { label: '医技', value: 'technician' },
...
const regionData = ref([
  ...
  { name: '重庆市', cities: [{ name: '重庆市', districts: ['万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '渝北区', '巴南区', '长寿区', '江津区', '合川区', '永川区', '南川区', '綦江区', '大足区', '璧山区', '铜梁区'] }] },
  { name: '广东省', cities: [
    ...
    { name: '东莞市', districts: ['莞城街道', '东城街道', '南城街道', '万江街道', '石碣镇', '石龙镇', '茶山镇', '石排镇', '企石镇', '横沥镇', '桥头镇', '谢岗镇', '东坑镇', '常平镇', '寮步镇', '大朗镇', '黄江镇', '清溪镇', '塘厦镇', '凤岗镇', '大岭山镇', '长安镇', '虎门镇', '厚街镇', '沙田镇', '道滘镇', '洪梅镇', '麻涌镇', '中堂镇', '高埗镇', '樟木头镇', '大岭山镇'] },
    { name: '中山市', districts: ['石岐街道', '东区街道', '西区街道', '南区街道', '五桂山街道', '中山港街道', '火炬开发区', '小榄镇', '古镇镇', '东升镇', '东凤镇', '南头镇', '阜沙镇', '黄圃镇', '三角镇', '民众镇', '南朗镇', '横栏镇', '港口镇', '大涌镇', '沙溪镇', '三乡镇', '板芙镇', '神湾镇', '坦洲镇'] },
  ...
  { name: '江苏省', cities: [
    ...
    { name: '苏州市', districts: ['姑苏区', '虎丘区', '吴中区', '相城区', '吴江区', '工业园区', '常熟市', '张家港市', '昆山市', '太仓市'] },
    { name: '南通市', districts: ['崇川区', '港闸区', '通州区', '海门区', '如东县', '启东市', '如皋市', '海安市'] },
  ...
  { name: '山东省', cities: [
    { name: '济南市', districts: ['历下区', '市中区', '槐荫区', '天桥区', '历城区', '长清区', '章丘区', '平阴县', '商河县', '济阳区'] },
    ...
    { name: '烟台市', districts: ['芝罘区', '福山区', '牟平区', '莱山区', '蓬莱市', '龙口市', '莱阳市', '莱州市', '招远市', '栖霞市', '海阳市', '长岛县'] },
    ...
    { name: '聊城市', districts: ['东昌府区', '茌平区', '临清市', '阳谷县', '莘县', '东阿县', '冠县', '高唐县'] },
  ...
  { name: '河南省', cities: [
    ...
    { name: '平顶山市', districts: ['新华区', '卫东区', '石龙区', '湛河区', '宝丰县', '叶县', '鲁山县', '舞钢市', '汝州市'] },
  ...
  { name: '四川省', cities: [
    { name: '成都市', districts: ['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', '双流区', '郫都区', '金堂县', '大邑县', '蒲江县', '新津县', '都江堰市', '彭州市', '邛崃市', '崇州市', '简阳市'] },
  ...
  { name: '湖南省', cities: [
    ...
    { name: '邵阳市', districts: ['双清区', '大祥区', '北塔区', '邵东县', '新邵县', '邵阳县', '隆回县', '洞口县', '绥宁县', '新宁县', '城步县', '武冈市'] },
    ...
    { name: '永州市', districts: ['零陵区', '冷水滩区', '祁阳县', '东安县', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华县'] },
  ...
  { name: '安徽省', cities: [
    ...
    { name: '芜湖市', districts: ['镜湖区', '弋江区', '三山区', '鸠江区', '芜湖县', '繁昌县', '南陵县', '无为县'] },
    ...
    { name: '安庆市', districts: ['迎江区', '大观区', '宜秀区', '怀宁县', '潜山县', '太湖县', '宿松县', '望江县', '岳西县', '桐城市'] },
  ...
  { name: '河北省', cities: [
    ...
    { name: '唐山市', districts: ['路南区', '路北区', '古冶区', '开平区', '丰南区', '丰润区', '曹妃甸区', '滦县', '滦南县', '乐亭县', '迁西县', '玉田县', '遵化市', '迁安市'] },
    ...
    { name: '承德市', districts: ['双桥区', '双滦区', '鹰手营子矿区', '承德县', '兴隆县', '平泉县', '滦平县', '隆化县', '丰宁县', '宽城县', '围场县'] },
  ...
  { name: '山西省', cities: [
    { name: '太原市', districts: ['小店区', '迎泽区', '杏花岭区', '尖草坪区', '万柏林区', '晋源区', '清徐县', '阳曲县', '娄烦县'] },
  ...
  { name: '江西省', cities: [
    ...
    { name: '抚州市', districts: ['临川区', '南城县', '黎川县', '南丰县', '崇仁县', '乐安县', '宜黄县', '金溪县', '资溪县', '东乡区', '广昌县'] },
  ...
  { name: '广西壮族自治区', cities: [
    ...
    { name: '桂林市', districts: ['秀峰区', '叠彩区', '象山区', '七星区', '雁山区', '临桂区', '阳朔县', '灵川县', '全州县', '兴安县', '灌阳县', '龙胜县', '资源县', '平乐县', '荔浦县', '恭城县'] },
    ...
    { name: '百色市', districts: ['右江区', '田阳县', '田东县', '平果县', '德保县', '那坡县', '凌云县', '乐业县', '田林县', '西林县', '隆林县', '靖西市'] },
  ...
  { name: '海南省', cities: [
    ...
    { name: '省直辖县级行政区划', districts: ['五指山市', '琼海市', '文昌市', '万宁市', '东方市', '定安县', '屯昌县', '澄迈县', '临高县', '白沙县', '昌江县', '乐东县', '陵水县', '保亭县', '琼中县'] }
  ]},
  { name: '贵州省', cities: [
    ...
    { name: '黔南布依族苗族自治州', districts: ['都匀市', '福泉市', '荔波县', '贵定县', '瓮安县', '独山县', '平塘县', '罗甸县', '长顺县', '龙里县', '惠水县', '三都县'] }
  ]},
  { name: '云南省', cities: [
    ...
    { name: '玉溪市', districts: ['红塔区', '江川区', '澄江县', '通海县', '华宁县', '易门县', '峨山县', '新平县', '元江县'] },
    ...
    { name: '红河哈尼族彝族自治州', districts: ['个旧市', '开远市', '蒙自市', '弥勒市', '屏边县', '建水县', '石屏县', '泸西县', '元阳县', '红河县', '金平县', '绿春县', '河口县'] },
    { name: '文山壮族苗族自治州', districts: ['文山市', '砚山县', '西畴县', '麻栗坡县', '马关县', '丘北县', '广南县', '富宁县'] },
    { name: '西双版纳傣族自治州', districts: ['景洪市', '勐海县', '勐腊县'] },
    { name: '大理白族自治州', districts: ['大理市', '漾濞县', '祥云县', '宾川县', '弥渡县', '南涧县', '巍山县', '永平县', '云龙县', '洱源县', '剑川县', '鹤庆县'] },
    { name: '德宏傣族景颇族自治州', districts: ['瑞丽市', '芒市', '梁河县', '盈江县', '陇川县'] },
    { name: '怒江傈僳族自治州', districts: ['泸水市', '福贡县', '贡山县', '兰坪县'] },
    { name: '迪庆藏族自治州', districts: ['香格里拉市', '德钦县', '维西县'] }
  ]},
  { name: '陕西省', cities: [
  ...
  { name: '甘肃省', cities: [
    ...
    { name: '陇南市', districts: ['武都区', '成县', '文县', '宕昌县', '康县', '徽县', '两当县', '礼县', '西和县'] },
    { name: '临夏回族自治州', districts: ['临夏市', '临夏县', '康乐县', '永靖县', '广河县', '和政县', '东乡县', '积石山县'] },
    { name: '甘南藏族自治州', districts: ['合作市', '临潭县', '卓尼县', '舟曲县', '迭部县', '玛曲县', '碌曲县', '夏河县'] }
  ]},
  { name: '青海省', cities: [
    { name: '西宁市', districts: ['城东区', '城中区', '城西区', '城北区', '大通县', '湟中县', '湟源县'] },
    { name: '海东市', districts: ['乐都区', '平安区', '民和县', '互助县', '化隆县', '循化县'] },
    { name: '海北藏族自治州', districts: ['门源县', '祁连县', '海晏县', '刚察县'] },
    { name: '黄南藏族自治州', districts: ['同仁县', '尖扎县', '泽库县', '河南县'] },
    ...
    { name: '海西蒙古族藏族自治州', districts: ['格尔木市', '德令哈市', '乌兰县', '都兰县', '天峻县', '茫崖市'] }
  ]},
  { name: '内蒙古自治区', cities: [
  ...
  { name: '新疆维吾尔自治区', cities: [
    ...
    { name: '昌吉回族自治州', districts: ['昌吉市', '阜康市', '呼图壁县', '玛纳斯县', '奇台县', '吉木萨尔县', '木垒县'] },
    { name: '博尔塔拉蒙古自治州', districts: ['博乐市', '阿拉山口市', '精河县', '温泉县'] },
    { name: '巴音郭楞蒙古自治州', districts: ['库尔勒市', '轮台县', '尉犁县', '若羌县', '且末县', '焉耆县', '和静县', '和硕县', '博湖县'] },
    ...
    { name: '伊犁哈萨克自治州', districts: ['伊宁市', '奎屯市', '霍尔果斯市', '伊宁县', '察布查尔县', '霍城县', '巩留县', '新源县', '昭苏县', '特克斯县', '尼勒克县'] },
    { name: '塔城地区', districts: ['塔城市', '乌苏市', '沙湾市', '额敏县', '托里县', '裕民县', '和布克赛尔县'] },
  ...
  { name: '香港特别行政区', cities: [{ name: '香港特别行政区', districts: ['中西区', '湾仔区', '东区', '南区', '油尖旺区', '深水埗区', '九龙城区', '黄大仙区', '观塘区', '荃湾区', '屯门区', '元朗区', '北区', '大埔区', '西贡区', '沙田区', '葵青区', '离岛区'] }] },
  { name: '澳门特别行政区', cities: [{ name: '澳门特别行政区', districts: ['花地玛堂区', '圣安多尼堂区', '大堂区', '望德堂区', '风顺堂区', '嘉模堂区', '圣方济各堂区', '路氹填海区'] }] },
  { name: '台湾省', cities: [{ name: '台湾省', districts: ['台北市', '新北市', '桃园市', '台中市', '台南市', '高雄市', '基隆市', '新竹市', '嘉义市', '新竹县', '苗栗县', '彰化县', '南投县', '云林县', '嘉义县', '屏东县', '宜兰县', '花莲县', '台东县', '澎湖县', '金门县', '连江县'] }] }
])

// 城市选项（根据选中的省份动态计算）
const cityOptions = computed(() => {
  const province = regionData.value.find(p => p.name === formData.value.province)
  return province?.cities || []
})

// 区县/乡镇选项（根据选中的城市动态计算）
const districtOptions = computed(() => {
  const city = cityOptions.value.find(c => c.name === formData.value.city)
...
const submitForm = () => {
  ...
  // 住址校验
  if (!formData.value.province || !formData.value.city || !formData.value.district || !formData.value.address) {
    alert('请完整填写住址信息')
    return
  }

  // 被反馈人员科室校验
  if (!formData.value.staffDept) {
    alert('请输入被反馈人员科室')
    return
  }

  // 被反馈人员姓名校验
  if (!formData.value.staffName) {
    alert('请输入被反馈人员姓名')
    return
  }

  // 被反馈人员类别校验
  if (!formData.value.staffCategory) {
    alert('请选择被反馈人员类别')
    return
  }
