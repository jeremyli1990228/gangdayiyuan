<template>
  <div class="page-container">
    <div class="breadcrumb">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-item active">转办知悉</span>
    </div>
    <h1 class="page-title">转办知悉</h1>
    ...
    <div class="table-container">
      <div class="table-header">
        ...
        <div class="table-cell" style="width: 160px;">转办时间</div>
        <div class="table-cell" style="width: 120px;">发起人</div>
        <div class="table-cell" style="width: 120px;">患者姓名</div>
        <div class="table-cell" style="width: 120px;">患者病号</div>
      ...
      <div class="table-body">
        <div class="empty-state">
          <svg class="empty-icon" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M60 70 L60 95 M45 85 L60 70 L75 85" fill="#f5f5f5" stroke="#e8e8e8" stroke-width="2"/>
          </svg>
...
<style scoped>
/* Same styles as Following.vue, reused */
.page-container {
  padding: 20px;
