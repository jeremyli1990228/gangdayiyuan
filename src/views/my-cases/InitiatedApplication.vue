<template>
  <div class="page-container">
    <div class="breadcrumb">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-item active">我发起的申请</span>
    </div>
    <h1 class="page-title">我发起的申请</h1>
    ...
    <div class="table-container">
      <div class="table-header">
        ...
        <div class="table-cell" style="width: 100px;">发起人</div>
        <div class="table-cell" style="width: 100px;">患者姓名</div>
        <div class="table-cell" style="width: 120px;">申请类型</div>
        <div class="table-cell" style="width: 100px;">申请状态</div>
        <div class="table-cell" style="width: 100px;">审批意见</div>
        <div class="table-cell" style="width: 140px;">提交时间</div>
        <div class="table-cell" style="width: 140px;">审批时间</div>
      </div>
      <div class="table-body">
        <div class="table-row" v-for="(item, index) in tableData" :key="index">
          ...
          <div class="table-cell" style="width: 100px;">{{ item.initiator }}</div>
          <div class="table-cell" style="width: 100px;">{{ item.patientName }}</div>
          <div class="table-cell" style="width: 120px;">{{ item.applicationType }}</div>
          <div class="table-cell" style="width: 100px;">
            <span class="status-tag" :class="item.statusClass">{{ item.status }}</span>
          </div>
          <div class="table-cell" style="width: 100px;">{{ item.approvalOpinion }}</div>
          <div class="table-cell" style="width: 140px;">{{ item.submitTime }}</div>
          <div class="table-cell" style="width: 140px;">{{ item.approvalTime }}</div>
        </div>
      </div>
    </div>
...
const tableData = ref([
  {
    ...
    initiator: '付世平',
    patientName: '张小明',
    applicationType: '案件完结申请',
    status: '已同意',
    statusClass: 'approved',
    approvalOpinion: '',
    submitTime: '2026-06-01 01:15:51',
    approvalTime: '2026-06-01 01:15:51'
  },
  {
    ...
    status: '已同意',
    statusClass: 'approved',
    approvalOpinion: '确认结案',
    submitTime: '2023-10-22 13:20:05',
    approvalTime: '2023-10-22 13:20:05'
  },
  {
