<template>
  <div class="page-container">
    <div class="breadcrumb">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-item active">移交我的</span>
    </div>
    <h1 class="page-title">移交我的</h1>
    ...
    <div class="table-container">
      <div class="table-header">
        ...
        <div class="table-cell" style="width: 120px;">原受理组</div>
        <div class="table-cell" style="width: 120px;">原受理人</div>
        <div class="table-cell" style="width: 150px;">移交说明</div>
        <div class="table-cell" style="width: 120px;">移交受理组</div>
        <div class="table-cell" style="width: 120px;">移交受理人</div>
        <div class="table-cell" style="width: 140px;">移交时间</div>
      </div>
      <div class="table-body">
        <div class="empty-state">
          <svg class="empty-icon" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="60" cy="45" r="25" fill="#f5f5f5" stroke="#e8e8e8" stroke-width="2"/>
            <path d="M60 70L60 95M45 85L60 70L75 85" fill="#f5f5f5" stroke="#e8e8e8" stroke-width="2"/>
          </svg>
