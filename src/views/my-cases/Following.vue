<template>
  <div class="page-container">
    <div class="breadcrumb">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-item active">我跟进的</span>
    </div>
    <h1 class="page-title">我跟进的</h1>
    ...
    <div class="table-container">
      ...
      <div class="table-body">
        <div class="table-row" v-for="(item, index) in tableData" :key="index">
          ...
          <div class="table-cell" style="width: 120px;">
            <span class="contact-status" :class="item.contactStatusClass">{{ item.contactStatus }}</span>
          </div>
...
const tableData = ref([
  ...
  },
  {
    ...
    replyTime: '无新回复',
    replyTimeClass: 'warning',
    contactStatus: '超时952天',
    contactStatusClass: 'danger',
