<template>
  <div class="page-container">
    <div class="breadcrumb">
      ...
      <span class="breadcrumb-item active">审批设置</span>
    </div>
    ...
    <div class="settings-section">
      <div class="settings-grid-header">
        <div class="grid-cell" style="width: 20%;">申请类型</div>
        <div class="grid-cell" style="width: 25%;">案件所在用户组</div>
        <div class="grid-cell" style="width: 25%;">审批人</div>
        <div class="grid-cell" style="width: 15%;">操作</div>
      </div>
      
      <div class="settings-grid-row">
        <div class="grid-cell" style="width: 20%;">
          <select class="form-select">
            <option>案件完结申请</option>
          </select>
        </div>
        ...
        <div class="grid-cell" style="width: 25%;">
          <input type="text" class="form-input" value="付世平" readonly/>
        </div>
