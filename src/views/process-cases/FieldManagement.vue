<template>
  <div class="page-container">
    <div class="breadcrumb">
      ...
      <span class="breadcrumb-separator">/</span>
      <span class="breadcrumb-item active">案件字段配置</span>
    </div>

    <div class="page-header">
      <h1 class="page-title">案件字段配置</h1>
...
const STORAGE_KEY = 'case_field_config'
...
const defaultSections = [
  {
    ...
    title: '患者信息',
    fields: [
      { key: 'name', name: '姓名', required: true, display: true, requiredField: true },
      { key: 'patientNo', name: '病人号', required: true, display: true, requiredField: true },
      ...
      { key: 'contact', name: '联系方式', required: true, display: true, requiredField: true },
      { key: 'address', name: '邮箱/地址', required: false, display: false, requiredField: false }
    ]
  },
  {
    key: 'feedback',
    title: '反馈人信息',
    fields: [
      { key: 'relation', name: '与患者关系', required: true, display: true, requiredField: true },
      { key: 'name', name: '姓名', required: true, display: true, requiredField: true },
      { key: 'age', name: '年龄', required: false, display: false, requiredField: false },
      { key: 'gender', name: '性别', required: false, display: false, requiredField: false },
      { key: 'contact', name: '联系方式', required: true, display: true, requiredField: true },
  ...
  },
  {
    ...
    title: '受理信息',
    fields: [
      { key: 'group', name: '受理组', required: true, display: true, requiredField: true },
      { key: 'handler', name: '受理人', required: true, display: true, requiredField: true },
      { key: 'caseType', name: '案件类型', required: true, display: true, requiredField: true },
      { key: 'replyType', name: '回复类型', required: true, display: true, requiredField: true },
      { key: 'replyDate', name: '回复日期', required: true, display: true, requiredField: true },
      { key: 'acceptDate', name: '受理日期', required: true, display: true, requiredField: true }
    ]
  },
  {
    key: 'reason',
    title: '原因及其诉求',
    fields: [
      { key: 'link', name: '涉及环节', required: false, display: false, requiredField: false },
      { key: 'reason', name: '原因', required: true, display: true, requiredField: true },
      { key: 'demand', name: '诉求', required: true, display: true, requiredField: true },
      { key: 'feedbackTime', name: '反馈时间', required: true, display: true, requiredField: true },
      { key: 'feedbackContent', name: '反馈内容', required: true, display: true, requiredField: true }
    ]
  },
  {
    key: 'channel',
    title: '反馈方式与涉及人员',
    fields: [
      { key: 'method', name: '反馈方式', required: true, display: true, requiredField: true },
      { key: 'department', name: '涉及科室', required: true, display: true, requiredField: true },
      { key: 'category', name: '科室类别', required: true, display: true, requiredField: true },
      { key: 'personnel', name: '涉及人员', required: false, display: false, requiredField: false },
      { key: 'customPersonnel', name: '自定义涉及人员', required: false, display: false, requiredField: false }
    ]
  },
  {
    key: 'medical',
    title: '病历摘要',
    fields: [
      { key: 'summary', name: '病历摘要', required: false, display: false, requiredField: false }
    ]
  },
  {
    key: 'followup',
    title: '跟进记录',
    fields: [
      { key: 'record', name: '跟进记录', required: true, display: true, requiredField: true }
    ]
  },
  {
    key: 'result',
    title: '处理结果',
    fields: [
      { key: 'result', name: '处理结果', required: true, display: true, requiredField: true }
    ]
  },
  {
    key: 'attachment',
    title: '上传附件',
    fields: [
      { key: 'file', name: '附件', required: false, display: false, requiredField: false }
    ]
  }
]
